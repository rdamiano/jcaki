...
public final class SimpleTextReader implements Closeable {
    ...
    public static SimpleTextReader trimmingUTF8Reader(File file) throws IOException {
        return new SimpleTextReader.Builder(file).encoding("utf-8").trim().ignoreWhiteSpaceLines().build();
    }
    ...
    public static LineIterator trimmingUTF8LineIterator(File file) throws IOException {
        return new SimpleTextReader.Builder(file).encoding("utf-8").trim().ignoreWhiteSpaceLines().build().getLineIterator();
    }
    ...
    public static IterableLineReader trimmingUTF8IterableLineReader(File file) throws IOException {
        return new SimpleTextReader.Builder(file).trim().ignoreWhiteSpaceLines().build().getIterableReader();
    }
    ...
    public static SimpleTextReader trimmingReader(InputStream is, String encoding) throws IOException {
        return new SimpleTextReader.Builder(is).encoding(encoding).trim().ignoreWhiteSpaceLines().build();
    }
    ...
    public static LineIterator trimmingLineIterator(InputStream is, String encoding) throws IOException {
        return new SimpleTextReader.Builder(is).encoding(encoding).trim().ignoreWhiteSpaceLines().build().getLineIterator();
    }
    ...
    public static IterableLineReader trimmingIterableLineReader(InputStream is, String encoding) throws IOException {
        return new SimpleTextReader.Builder(is).encoding(encoding).trim().ignoreWhiteSpaceLines().build().getIterableReader();
    }
     ...
     * {@link org.jcaki.IOs#closeSilently} method.
     *
